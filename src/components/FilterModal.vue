<template>
  <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-end transition-opacity duration-300">
    <div class="bg-white w-full rounded-t-3xl max-h-[85vh] overflow-hidden flex flex-col">
      <div class="p-6 border-b border-gray-200 flex justify-between items-center bg-white flex-shrink-0">
        <div>
